...
class LanguageSelectedAdapter(
    private val languages: List<AppLanguages>,
    var ctx: Context,
    private val onItemClickListener: (position: Int) -> Unit,
    private val reloadAds: Boolean, // Add this flag
) : RecyclerView.Adapter<LanguageSelectedAdapter.LanguageViewHolder>() {
...
//            /*listener?.onItemClick(holder.selectedBackground, position)*/
...
//        }
        ...
        holder.itemView.setOnClickListener {
            ...
            // Trigger the language selection logic
            onItemClickListener(position)
            ...
            itemView.setOnClickListener {
                listener?.let {
                    ...
                    if (position != RecyclerView.NO_POSITION) {
                        it.onItemClick(itemView, position)
                    }
                }
            }
        }*/
