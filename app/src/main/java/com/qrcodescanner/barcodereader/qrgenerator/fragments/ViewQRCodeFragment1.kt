...
class ViewQRCodeFragment1 : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_view_q_r_code1, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnShare.setOnClickListener {
            shareQRCodeImage() // Share the QR code image
        }
        ...
        requireActivity().onBackPressedDispatcher.addCallback(
            ...
            object : OnBackPressedCallback(true) {
                override fun handleOnBackPressed() {
                    val action =
                        ViewQRCodeFragment1Directions.actionFastToHome()
    ...
    private fun shareQRCodeImage() {
        ...
        val fileUri = FileProvider.getUriForFile(
            requireContext(), "com.qrcodescanner.barcodereader.qrgenerator.fileprovider", file)
